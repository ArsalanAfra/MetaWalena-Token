...
const MetaWlenaToken = artifacts.require('MetaWlenaToken');
...
const WLNReceiver = artifacts.require("WLNReceiver");

contract('MetaWlenaToken', (accounts) => {
...
    beforeEach(async () => {
        token = await MetaWlenaToken.new(totalSupply, {from: owner});
    });
...
            beforeEach(async () => {
                recipient = await WLNReceiver.new({owner});
            });
